...
# 사용자가 입력한 값이 임의의 숫자와 같을 때까지 반복
while 1==1: #true
    # 사용자에게 입력 받음
    user_input = int(input("1부터 100 사이의 숫자를 입력해주세요: "))
    count += 1
    
    # 사용자가 입력한 값이 임의의 숫자보다 낮을 때
    if user_input < random_number:
        print("UP")
    # 사용자가 입력한 값이 임의의 숫자보다 높을 때
    elif user_input > random_number:
        print("DOWN")
    # 사용자가 입력한 값이 임의의 숫자와 같을 때
    elif user_input == random_number:
        print("축하합니다! {}회 만에 맞추셨습니다.".format(count))
        break
